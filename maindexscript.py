...
class Pokemon:
    ...
    def WriteAllData(self, results):
        if not os.path.isdir("Data/NewData/"+self.thisPokemonName):
            os.makedirs(os.path.join('.','Data','NewData',self.thisPokemonName))
        textFile = open(os.path.join('.','Data','NewData',self.thisPokemonName,'usage.txt'),'w')
...
resultsFile = open("Data/NewData/results.txt",'w+')
